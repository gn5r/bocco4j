...
public class BoccoAPI {
	...
	/**
	 * 受け取ったAPIKey、アプリで登録したメールアドレスとパスワードを入力
	 * 
	 * @param APIKey
	 * @param Email
	 * @param Password
	...
	/**
	 * access_tokenを取得する。<br>
	 * 401または400ならfalseを返し、正常取得ならtrueが返ってくる
	 * 
	 * @return boolean
	 * @throws Exception
	 */
	...
	/**
	 * 1件目のroom情報を取得しroomIDを取り出す<br>
	 * 
	 * 正常取得でtrueを返し、コンソールにroomIDを表示させている。<br>401または400ならfalseを返却
	 * 
	 * @return
	 * @throws Exception
	 */
	...
	/**
	 * テキストメッセージを送信<br>
	 * 正常に送信できたならtrueを返却。401または400ならfalseを返却する
	 * 
	 * @param message
	 * @return
	 * @throws Exception
	...
	public boolean postMessage(String message) throws Exception {
		...
		/* POSTボディデータを作成 */
		String data = "access_token=" + accsessToken + "&media=text&text=" + message + "&unique_id=" + uuid.toString();
